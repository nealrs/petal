...
(function() {
  ...
  load_reply = function() {
    $(".petal .reply").append("    <p class=\"note\">Require Github account.</p>    <p class=\"err\"></p>    <textarea id=\"petal-textarea\"></textarea>    <p class=\"note\" >Press Ctrl+Enter to post your comment.</p>  ");
  ...
  test_token = function() {
    ...
    if (token) {
      ...
      storage = window.localStorage;
      return storage.setItem("petaltoken", token);
    }
  };
