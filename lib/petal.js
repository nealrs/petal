(function() {
  var $, api_base, append_com, authorize, client_id, err, load_comments, load_footer, load_reply, marked, petal, post_reply, proxy_url, render_body, test_token, test_un_reply, users;
